...
export const allMalikiPrayers: PrayerDefinition[] = [
  fajr, dhuhr, asr, maghrib, isha, witr, sunnahRawatib, tarawih,
];

export function getMalikiPrayerById(id: PrayerId): PrayerDefinition | undefined {
  return allMalikiPrayers.find(p => p.id === id);
}
