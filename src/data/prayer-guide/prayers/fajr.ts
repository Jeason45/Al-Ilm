...
export const fajr: PrayerDefinition = {
  ...
  ruling: 'fard',
  rakaatCount: 2,
  description: 'Prière de l\'aube — 2 unités (rak\'at)',
  rakaat: [
    // ──────────────── Rak'a 1 ────────────────
    {
      number: 1,
      steps: [
        ...
        },
        {
          ...
          notes: 'Réciter sourate Al-Fatiha (1) en entier. La récitation est à voix haute (jahr) pour le Fajr.',
        },
        {
          id: 'fajr-r1-surah',
          position: 'qiyam-hands',
          ...
          nameAr: 'قراءة سورة',
          notes: 'Réciter une sourate ou quelques versets après la Fatiha. La récitation est à voix haute.',
        },
        {
          id: 'fajr-r1-takbir-ruku',
          position: 'takbir',
          ruling: 'wajib',
