...
export const allHanbaliPrayers: PrayerDefinition[] = [
  fajr, dhuhr, asr, maghrib, isha, witr, sunnahRawatib, tarawih,
];

export function getHanbaliPrayerById(id: PrayerId): PrayerDefinition | undefined {
  return allHanbaliPrayers.find(p => p.id === id);
}
