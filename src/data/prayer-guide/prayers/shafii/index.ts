...
export const allShafiiPrayers: PrayerDefinition[] = [
  fajr, dhuhr, asr, maghrib, isha, witr, sunnahRawatib, tarawih,
];

export function getShafiiPrayerById(id: PrayerId): PrayerDefinition | undefined {
  return allShafiiPrayers.find(p => p.id === id);
}
