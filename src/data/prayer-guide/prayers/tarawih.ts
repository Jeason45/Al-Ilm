...
export const tarawih: PrayerDefinition = {
  ...
  rakaatCount: '8 ou 20',
  description: 'Prière nocturne du Ramadan — séries de 2 rak\'at',
  rakaat: [
    // ──────────────── Rak'a 1 ────────────────
    {
      number: 1,
      steps: [
        ...
        },
        {
          ...
          notes: 'Réciter sourate Al-Fatiha (1) en entier. La récitation se fait à voix haute (jahr) pour les tarawih.',
        },
        {
          id: 'tarawih-r1-surah',
          position: 'qiyam-hands',
          ...
          nameAr: 'قراءة سورة',
          notes: 'Réciter une sourate ou un passage du Coran après la Fatiha. La récitation est à voix haute. Il est recommandé de lire de longs passages durant les tarawih.',
        },
        {
          id: 'tarawih-r1-takbir-ruku',
          position: 'takbir',
          ruling: 'wajib',
    ...
    // ──────────────── Rak'a 2 ────────────────
    {
      ...
      steps: [
        ...
        },
        {
          ...
          dhikrAr: 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ',
          dhikrTranslit: 'Bismillahi ar-Rahmani ar-Rahim…',
          notes: 'Réciter sourate Al-Fatiha (1) en entier. La récitation est à voix haute.',
        },
        {
          id: 'tarawih-r2-surah',
          position: 'qiyam-hands',
          ...
          name: 'Récitation d\'une sourate',
          nameAr: 'قراءة سورة',
          notes: 'Réciter une sourate ou un passage du Coran après la Fatiha. La récitation est à voix haute.',
        },
        {
          id: 'tarawih-r2-takbir-ruku',
          position: 'takbir',
          ruling: 'wajib',
          name: 'Takbir de transition vers le ruku\'',
          nameAr: 'تكبيرة الانتقال للركوع',
