...
export const maghrib: PrayerDefinition = {
  ...
  ruling: 'fard',
  rakaatCount: 3,
  description: 'Prière du coucher du soleil — 3 unités (rak\'at)',
  rakaat: [
    // ── Rak'a 1 ──────────────────────────────────────────────
    {
      number: 1,
      steps: [
        ...
        },
        {
          ...
          notes: 'Récitée à voix haute (prière du Maghrib). Dire « Amin » à la fin.',
        },
        {
          id: 'maghrib-r1-surah',
          position: 'qiyam-hands',
          ...
          nameAr: 'قراءة سورة',
          notes: 'Réciter à voix haute une sourate ou quelques versets après la Fatiha.',
        },
        {
          id: 'maghrib-r1-takbir-ruku',
          position: 'takbir',
          ruling: 'wajib',
    ...
    // ── Rak'a 2 ──────────────────────────────────────────────
    {
      ...
      steps: [
        ...
        },
        {
          ...
          dhikrAr: 'الحمد لله رب العالمين، الرحمن الرحيم، مالك يوم الدين، إياك نعبد وإياك نستعين، اهدنا الصراط المستقيم، صراط الذين أنعمت عليهم غير المغضوب عليهم ولا الضالين',
          dhikrTranslit: 'Al-hamdu lillahi Rabbil-\'alamin, ar-Rahmanir-Rahim, Maliki yawmid-din, iyyaka na\'budu wa iyyaka nasta\'in, ihdinas-siratal-mustaqim, siratal-ladhina an\'amta \'alayhim ghayril-maghdubi \'alayhim walad-dallin',
          notes: 'Récitée à voix haute. Dire « Amin » à la fin.',
        },
        {
          id: 'maghrib-r2-surah',
          position: 'qiyam-hands',
