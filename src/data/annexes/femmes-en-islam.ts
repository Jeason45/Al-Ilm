import type { FemmeEnIslam } from '../types';

export const femmesEnIslam: FemmeEnIslam[] = [
  {
    nom: "Maryam (Marie)",
    titre: "La plus vertueuse des femmes de l'humanité",
    sourate: "Maryam (19), Al-Imran (3), At-Tahrim (66)",
    histoire: "Maryam est la seule femme mentionnée par son nom dans le Coran, avec une sourate entière portant son nom (sourate 19). Elle fut choisie par Allah au-dessus de toutes les femmes des mondes et purifiée pour recevoir le miracle de la naissance virginale de Isa (Jésus). Dès son enfance, elle vécut dans le temple sous la tutelle de Zakariya, recevant miraculeusement des provisions divines. Le Coran la décrit comme un modèle de piété, de chasteté et de soumission totale à Allah."
  },
  {
    nom: "Asiya (femme de Pharaon)",
    titre: "La croyante dans la maison du tyran",
    sourate: "At-Tahrim (66), Al-Qasas (28)",
    histoire: "Asiya bint Muzahim est citée dans le Coran comme un exemple pour les croyants. Épouse du plus grand tyran de l'histoire, Pharaon, elle embrassa secrètement la foi en Allah après avoir été témoin des miracles de Musa. C'est elle qui sauva le bébé Musa des eaux du Nil et le recueillit au palais. Elle invoqua Allah en disant : « Seigneur, construis-moi auprès de Toi une maison au Paradis », préférant la proximité d'Allah au luxe du palais de Pharaon, même au prix de sa vie."
  },
  {
  ...
  },
  {
    ...
    titre: "La savante de l'Islam et mère des croyants",
    sourate: "Référencée dans An-Nur (24), Al-Ahzab (33)",
    histoire: "Aisha est la fille d'Abu Bakr, le plus proche compagnon du Prophète, et l'une des épouses les plus érudites de l'histoire de l'Islam. Elle a transmis plus de 2200 hadiths du Prophète et était consultée par les plus grands compagnons sur les questions de jurisprudence et de théologie. Sa mémoire exceptionnelle et son intelligence firent d'elle une autorité incontournable dans les sciences islamiques. La sourate An-Nur (24) contient les versets qui innocentèrent Aisha de fausses accusations, confirmant sa vertu depuis le ciel."
  },
  {
  ...
  {
    nom: "Hawa (Ève)",
    titre: "La mère de l'humanité",
    sourate: "Al-Baqara (2), Al-A'raf (7), Ta-Ha (20)",
    histoire: "Hawa est la première femme créée par Allah comme compagne pour Adam. Le Coran ne la mentionne pas par son nom mais la désigne comme l'épouse d'Adam. Contrairement à d'autres traditions, le Coran ne fait pas porter à Hawa seule la responsabilité de la désobéissance : les deux époux furent trompés par Iblis et se repentirent ensemble. Le Coran dit : « Ils dirent : Seigneur, nous nous sommes fait du tort à nous-mêmes. » Hawa représente le début de la complémentarité homme-femme voulue par Allah."
  },
  {
    nom: "Sarah",
    titre: "L'épouse patiente d'Ibrahim",
    sourate: "Hud (11), Adh-Dhariyat (51)",
    histoire: "Sarah est l'épouse d'Ibrahim et la mère d'Ishaq. Le Coran relate la scène où des anges, sous forme humaine, lui annoncèrent la naissance d'un fils alors qu'elle était très âgée et stérile. Surprise par cette nouvelle, elle se frappa le visage d'étonnement. Allah lui accorda Ishaq puis Yaqub, récompensant sa longue patience durant des décennies de stérilité. Son histoire illustre que les promesses d'Allah se réalisent toujours, même quand les causes naturelles semblent impossibles."
  },
  {
    nom: "Hajar",
  ...
  },
  {
    ...
    titre: "La femme du ministre d'Égypte",
    sourate: "Yusuf (12)",
  ...
  {
    nom: "Soeur de Musa",
    titre: "La jeune fille courageuse et rusée",
    sourate: "Al-Qasas (28), Ta-Ha (20)",
    histoire: "La soeur de Musa joua un rôle crucial dans le plan divin de sauvetage. Sa mère l'envoya suivre discrètement le coffre contenant le bébé Musa sur le Nil. Quand le bébé fut recueilli par la famille de Pharaon et qu'il refusait toutes les nourrices, sa soeur intervint avec intelligence en proposant : « Voulez-vous que je vous indique une famille qui le prendra en charge pour vous et qui en prendra soin ? » Grâce à son courage et sa présence d'esprit, Musa fut rendu à sa propre mère, accomplissant ainsi la promesse d'Allah."
  }
];
