...
const PRAYER_POSES: Record<PrayerPositionId, PrayerPoseConfig> = {
  ...
  // Standing with hands folded on belly (right hand over left wrist)
  'qiyam-hands': {
    hips: { position: v(0, 0, 0), rotation: ZERO },
    spine: ZERO,
    spine1: v(-3 * D, 0, 0),
    ...
    head: v(-8 * D, 0, 0),
    leftShoulder: ZERO,
    leftArm: v(0.6, 0.3, 0.7),
    leftForeArm: v(-0.6, 0.8, 0),
    leftHand: v(0, 0.2, 0),
    rightShoulder: ZERO,
    rightArm: v(0.6, -0.3, -0.7),
    rightForeArm: v(-0.6, -0.8, 0),
    rightHand: v(0, -0.2, 0),
    leftUpLeg: v(0, 0, 0.02),
    leftLeg: ZERO,
    leftFoot: ZERO,
  ...
  ruku: {
    hips: { position: v(0, -0.12, 0.1), rotation: v(75 * D, 0, 0) },
    spine: v(5 * D, 0, 0),
    spine1: v(3 * D, 0, 0),
    spine2: v(2 * D, 0, 0),
    neck: v(-20 * D, 0, 0),
    head: v(-10 * D, 0, 0),
    leftShoulder: ZERO,
    leftArm: v(0.6, 0.1, 0.35),
    leftForeArm: v(0.2, 0, 0),
    leftHand: v(0.15, 0, 0),
    rightShoulder: ZERO,
    rightArm: v(0.6, -0.1, -0.35),
    rightForeArm: v(0.2, 0, 0),
    rightHand: v(0.15, 0, 0),
    leftUpLeg: v(-75 * D, 0, 0.02),
    leftLeg: v(5 * D, 0, 0),
    leftFoot: v(15 * D, 0, 0),
    rightUpLeg: v(-75 * D, 0, -0.02),
    rightLeg: v(5 * D, 0, 0),
    rightFoot: v(15 * D, 0, 0),
  },
  ...
  // Full prostration — forehead on ground, knees bent, hands beside head on ground
  sujud: {
    hips: { position: v(0, -0.45, -0.2), rotation: v(55 * D, 0, 0) },
    spine: v(30 * D, 0, 0),
    spine1: v(20 * D, 0, 0),
    spine2: v(15 * D, 0, 0),
    neck: v(10 * D, 0, 0),
    head: v(15 * D, 0, 0),
    leftShoulder: v(0, 0, 0.1),
    leftArm: v(0.3, 0.3, 0.6),
    leftForeArm: v(0.3, 0.5, 0),
    leftHand: v(0.2, 0, 0),
    rightShoulder: v(0, 0, -0.1),
    rightArm: v(0.3, -0.3, -0.6),
    rightForeArm: v(0.3, -0.5, 0),
    rightHand: v(0.2, 0, 0),
    leftUpLeg: v(-55 * D, 0, 0.05),
    leftLeg: v(-120 * D, 0, 0),
    leftFoot: v(-40 * D, 0, 0),
    rightUpLeg: v(-55 * D, 0, -0.05),
    rightLeg: v(-120 * D, 0, 0),
    rightFoot: v(-40 * D, 0, 0),
  },

  // Sitting between two prostrations — knees bent under body, hands on knees
  julus: {
    hips: { position: v(0, -0.55, 0), rotation: v(5 * D, 0, 0) },
    spine: v(-8 * D, 0, 0),
    spine1: v(-5 * D, 0, 0),
    spine2: v(-2 * D, 0, 0),
    neck: ZERO,
    head: v(-5 * D, 0, 0),
    leftShoulder: ZERO,
    leftArm: v(0.5, 0.1, 0.35),
    leftForeArm: v(0.3, 0.2, 0),
    leftHand: v(0.1, 0, 0),
    rightShoulder: ZERO,
    rightArm: v(0.5, -0.1, -0.35),
    rightForeArm: v(0.3, -0.2, 0),
    rightHand: v(0.1, 0, 0),
    leftUpLeg: v(-85 * D, 0.15, 0.1),
    leftLeg: v(-140 * D, 0, 0),
    leftFoot: v(-15 * D, 0, 0.3),
    rightUpLeg: v(-85 * D, -0.15, -0.1),
    rightLeg: v(-140 * D, 0, 0),
    rightFoot: v(-15 * D, 0, -0.3),
  },

  // Sitting for tashahud — hands on knees, right index finger pointed
  tashahud: {
    hips: { position: v(0, -0.55, 0), rotation: v(5 * D, 0, 0) },
    spine: v(-8 * D, 0, 0),
    spine1: v(-5 * D, 0, 0),
  ...
  // Sitting, head turned right for salam — hands on knees
  salam: {
    hips: { position: v(0, -0.55, 0), rotation: v(5 * D, 0, 0) },
    spine: v(-8 * D, 0, 0),
    spine1: v(-5 * D, 0, 0),
